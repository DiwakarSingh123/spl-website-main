      ...
      <div className="relative w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 md:p-12 overflow-visible">
        ...
        <div className="relative z-10 text-center max-lg:mt-20">
          <div className="mx-auto mb-6 sm:mb-8 w-32 sm:w-40 md:w-48 lg:w-52">
            <Image src="/Hero.png" alt="SPL Logo" width={200} height={120} className="object-contain w-full h-auto" priority />
          </div>
          ...
          <div className="mt-6 inline-block bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-4 py-1.5 rounded-full text-xs font-headline font-bold uppercase tracking-wider">
            Admin Portal
          </div>
        </div>
      </div>

      {/* RIGHT PANEL - with icon box */}
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-6 sm:mb-8 text-center lg:text-left">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm font-body">
              Sign in to manage SPL Tournament
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" required value={credentials.email} onChange={e => setCredentials({ ...credentials, email: e.target.value })} placeholder="admin@spl.com" className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100 rounded-xl pl-10 pr-4 py-2.5 sm:py-3 text-sm placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 transition-all" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required value={credentials.password} onChange={e => setCredentials({ ...credentials, password: e.target.value })} placeholder="Enter your password" className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100 rounded-xl pl-10 pr-4 py-2.5 sm:py-3 text-sm placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all" />
              </div>
            </div>

            <button type="submit" disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white py-3 sm:py-3.5 font-headline font-black uppercase tracking-tight text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed rounded-full shadow-md">
              {loading ? (
          ...
          <div className="space-y-3 text-center">
            <Link href="/coordinator/login" className="block text-sm font-body text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              District Coordinator? <span className="text-blue-600 dark:text-blue-400 font-semibold">Login here →</span>
            </Link>
            <Link href="/" className="block text-xs font-body text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
              ← Back to SPL Website
            </Link>
          </div>
        </div>
